							...
							<form action="<?php echo base_url('leanding/cektarif') ?>" method="post">
								<div class="main-search-input">
									...
									<div class="main-search-input-item">
										...
										<input id="myInput" type="text" name="myCountry" placeholder="Country" style="height: 29px;">
										<input id="myHiddenInput" type="hidden" name="myHiddenInput">
									</div>
									<div class="main-search-input-item">
...
<script type="text/javascript">
	  ...
	  $('.itemName1').select2({
		...
		$.get("json_data/data_wlayah.json", function(data, status){
			// var arr = JSON.parse(data);
			console.log("string data: ", data); 
			// console.log("JavaScript array", arr);
