...
class mpolist extends CI_Model
{
    ...
    var $column_order = array('po_no', 'po_desc', 'milestone', 'material_no', 'po_position', 'status', 'progress', ''); //set column field database for datatable orderable
    var $column_search = array('po_no', 'po_desc', 'milestone', 'material_no', 'po_position', 'status', 'progress', ''); //set column field database for datatable searchable just firstname , lastname , address are searchable
