            ...
            <div class="col-md-12">
               ...
               <div class="panel panel-default">
                  <div class="panel-heading">
                     <h3 class="panel-controls"><a href="javascript:void(0);"  data-toggle="modal" data-target="#myModal" class="btn btn-success">Upload New Rate</button>&nbsp<a href="<?php echo base_url('rateuploadhistory') ?>" class="btn btn-primary">Upload History</a></h3>
                  </div>
