...
class rateuploadhistory extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $data['data'] = $this->db->query("SELECT count(*) as total_update,rth.update_by,rth.file_name,rth.created_date FROM rate_tabel_history rth GROUP BY rth.file_name ORDER BY rth.created_date desc limit 500")->result();
