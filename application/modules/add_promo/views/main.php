                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">                                        
                                                <label class="col-md-3 control-label">Highlight</label>
                                            ...
                                            <div class="form-group">                                        
                                                <label class="col-md-3 control-label">Start Promo</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">                                        
                                                <label class="col-md-3 control-label">End Promo</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
