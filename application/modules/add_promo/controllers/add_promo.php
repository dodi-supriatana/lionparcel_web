...
class add_promo extends MX_Controller
{
    ...
    {
        $list = $this->Maddpromo->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->Maddpromo->count_all(),
            "recordsFiltered" => $this->Maddpromo->count_filtered(),
            "data" => $data,
        );
            ...
            if (empty($error)) {
                ...
                try {
                    ...
                    foreach ($allDataInSheet as $value) {
                        ...
                        $data = $this->Maddpromo->cek_po_ganda($value['B']);
                    ...
                    // die();
                    $result = $this->Maddpromo->importData($inserdata);
                    if ($result) {
