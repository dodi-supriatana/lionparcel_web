<li><a href="#">Home</a></li>
<li class="active">Agent Registrasion</li>
</ul>
<!-- END BREADCRUMB -->
            ...
            <div class="col-md-12">
               ...
               <div class="panel panel-default">
                  <div class="panel-heading">
                     <h3 class="panel-title"><i class="fa-fw fa fa-user"></i>
               Agent Registrasion</h3>
                        ...
                        <tbody>
                           <?php foreach ($list_user as $data) { ?>
                              <tr>
                                 ...
                                 <td>
                                    <a data-toggle="tooltip" data-placement="right" title="" data-original-title="View Detail" href="<?php echo base_url() ?>" ><span class="label label-primary" ><i class="glyphicon glyphicon-user"></i></span></a>
                                    <a data-toggle="tooltip" data-placement="right" title="" data-original-title="Reject" href="<?php echo base_url() ?>" ><span class="label label-danger" ><i class="glyphicon glyphicon-remove"></i></span></a>
                                    <a data-toggle="tooltip" data-placement="right" title="" data-original-title="Approve" href="<?php echo base_url() ?>" ><span class="label label-success" ><i class="glyphicon glyphicon-ok"></i></span></a>                                 
                                 </td>
                                 <!-- <td>
