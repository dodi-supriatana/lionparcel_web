...
<div class="page-content-wrap">
    ...
    <div class="col-md-3">
      ...
      <div style="overflow: hidden; padding-top: 0; min-height: auto;" class="widget widget-default widget-item-icon">
        <div class="widget-item-left" style="background-color: #4DC6F4;margin-bottom: -8px;margin-left: 0px;width: 80px;">
          <span class="fa fa-cube" style="color:#ffff; align-item: center;"></span>
        </div>
        <div class="widget-data">
    ...
    <div class="col-md-8">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body padding-0">
          ...
          <div id="container3" style="min-width: 310px; height: 200px; margin: 0 auto"></div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <div class="panel-title-box">
            <h3>Trend Penambahan Agen</h3>
            <!-- <span>Event "Purchase Button"</span> -->
          </div>

        </div>
        <div class="panel-body padding-0">
          <div class="chart-holder" id="container" style="height: 200px;"></div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Agent Vs Non Agent</h3>
          <ul class="panel-controls">
            <li><a href="#" class="control-danger"><span class="fa fa-pencil"></span></a></li>
          </ul>
        </div>
        <div class="panel-body scroll" style="height: 230px;">
          <div id="container2" style="min-width: 100%; height: 100%; max-width: 600px; margin: 0 auto"></div>
        </div>
      </div>
      <!-- END SALES BLOCK -->
    ...
    <div class="col-md-4">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Active Promo</h3>
          <ul class="panel-controls">
            <li><a href="#" class="control-danger"><span class="fa fa-pencil"></span></a></li>
          </ul>
        </div>
        <div class="panel-body scroll" style="height: 230px;">
          <h6>Duit Dua Kilo Irit</h6>
          <p>
            Kirim Barang 2 Kg, Biaya Cuma 1 Kg
            <span class="text-muted"><i class="fa fa-clock-o"></i> 14:15 Today</span>
          </p>
          <hr>
          <h6>Ongkir Cashback 15 %</h6>
          <p>
            Bukalapak. khusus Pelapak
            <span class="text-muted"><i class="fa fa-clock-o"></i> 10:22 Today</span>
          </p>
          <hr>
          <h6>Geratis Ongkir</h6>
          <p>
            Belanja Tanpa Ragu Lion Parcel Pilihan mu
    ...
    <div class="col-md-4">
      ...
      <div class="widget widget-primary">
        <div class="widget-title">Last Update Rate</div>
        <div class="widget-int"><span class="fa fa-calendar"></span> <span data-toggle="counter" data-to="1,623,000">16 April 2019</span></div>
      </div>
      <div class="widget widget-primary" style="background: black;">
        <div class="widget-title">Last Update Promo</div>
        <div class="widget-int"><span class="fa fa-calendar"></span> <span data-toggle="counter" data-to="1,623,000">29 Juni 2019</span></div>
      </div>
      <!-- END SALES BLOCK -->
