      ...
      <div class="page-content-wrap">
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <form class="form-horizontal" action="<?php echo base_url('price') ?>" method="POST">
                  <div class="panel panel-default">
                     <div class="panel-heading">
                        <h3 class="panel-title"><strong><i class="fa-fw fa fa-usd"></i></strong>  Price</h3>
                           ...
                           <div class="col-md-4">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    ...
                                    <span class="help-block">Search Origin</span>
                                 </div>
                              </div>
                           ...
                           <div class="col-md-4">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    ...
                                    <span class="help-block">Search Destination</span>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-4">
            ...
            <div class="col-md-4">
               ...
               <div class="panel panel-default">
                  <div class="panel-body panel-body-image">
                     <img src="<?php echo base_url('assets/leandingpage/images/promo/duit_horisontal2.jpg') ?>" alt="Ocean">
                  ...
                  <div class="panel-body">
                     ...
                     <h3>Rp <?php echo number_format($data->final_price ,2,',','.') ?></h3>
                     <p><?php echo $data->dari ?> - <?php echo $data->ke ?></p>
                  </div>
               </div>
